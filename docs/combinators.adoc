...
- `https://pkg.go.dev/github.com/purpleclay/chomp#pkg-variables:[IsDigit]`
- `https://pkg.go.dev/github.com/purpleclay/chomp#pkg-variables:[IsLetter]`
- `https://pkg.go.dev/github.com/purpleclay/chomp#pkg-variables:[IsAlphanumeric]`
- `https://pkg.go.dev/github.com/purpleclay/chomp#pkg-variables:[IsLineEnding]`
